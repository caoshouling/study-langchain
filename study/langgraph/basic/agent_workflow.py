...
planner = planner_prompt | ChatOpenAI(openai_api_base= "https://dashscope.aliyuncs.com/compatible-mode/v1",
                 model_name='qwen-turbo',
                 api_key ="sk-474e1a10893e4913bbe860dc90edda42", temperature=0).with_structured_output(Plan)
...
replanner = (replanner_prompt | ChatOpenAI(openai_api_base= "https://dashscope.aliyuncs.com/compatible-mode/v1",
                 model_name='qwen-turbo',
                 api_key ="sk-474e1a10893e4913bbe860dc90edda42", temperature=0
                 ).with_structured_output(Plan))
...
{plan_str}\n\n你的任务是执行第{1}步，{task}。"""
    ...
    # 输入数据
    inputs = {"input": "2025年央视春晚中，演唱《世界赠予我的》的歌手是哪里人？今年多少岁了？请用中文答复"}
    # 异步执行状态图，输出结果

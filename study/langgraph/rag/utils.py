...
PLATFORMS = ["OpenAI","Ollama", "Xinference","LM Studio"] # ["fastchat"] "ZhipuAI",
...
def get_llm_models(platform_type: Literal[tuple(PLATFORMS)], base_url: str="", api_key: str="EMPTY"):
    if platform_type == "LM Studio":
        try:
            ...
            # )
          # 返回模型列表
            return ["paultimothymooney/qwen2.5-7b-instruct","qwen2.5-14b-instruct"]
